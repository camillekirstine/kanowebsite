...
<head>
    ...
    <meta property="og:url" content="https://camillekirstine.com/kanohair/products.php"/>
        ...
        <article>
            <div class="row ms-xl-2">
                ...
                <div class="row col-lg-6 mx-auto py-lg-3 pe-lg-5">
                    <img alt="image of products with a colourful frame design around it" class="framed mx-auto" src="images/productsframe.webp">
                </div>
            </div>
        </article>
    </section>
